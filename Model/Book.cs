    ...
    public partial class Book : Product
    {
    	...
    	public override int GetHashCode()
    	{
    	    unchecked
    	    {
    			...
    			hash = hash * multiplier + edition.GetHashCode();
    	...
    	public override String ToString()
    	{
    		...
    		strBook.Append("[ ");
           strBook.Append(" editorial = " + editorial + " | " );       
           strBook.Append(" ISBN = " + ISBN + " | " );       
           strBook.Append(" edition = " + edition + " | " );       
           strBook.Append(" pages = " + pages + " | " );       
           strBook.Append(" publicationDate = " + publicationDate + " | " );       
            strBook.Append("] ");    
